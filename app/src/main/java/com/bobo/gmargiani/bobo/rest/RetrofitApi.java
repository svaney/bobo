...
public class RetrofitApi extends NetApi {
    ...
    @Override
    public void getAppVersion(String deviceType, String channel, RestCallback<ApiResponse<AppVersion>> callback) {
        Call<ApiResponse<AppVersion>> call = retService.getAppVersion(COMMON_GET_APP_CLIENT_STATUS, deviceType, channel);
