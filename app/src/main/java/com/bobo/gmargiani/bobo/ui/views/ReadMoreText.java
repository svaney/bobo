...
public class ReadMoreText extends android.support.v7.widget.AppCompatTextView {
    ...
    public ReadMoreText(Context context) {
        this(context, null);
    }

    public ReadMoreText(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        int resourceIdTrimCollapsedText =
                typedArray.getResourceId(com.borjabravo.readmoretextview.R.styleable.ReadMoreTextView_trimCollapsedText, com.borjabravo.readmoretextview.R.string.read_more);
        int resourceIdTrimExpandedText =
                typedArray.getResourceId(com.borjabravo.readmoretextview.R.styleable.ReadMoreTextView_trimExpandedText, com.borjabravo.readmoretextview.R.string.read_less);
        ...
        this.colorClickableText = typedArray.getColor(com.borjabravo.readmoretextview.R.styleable.ReadMoreTextView_colorClickableText,
                ContextCompat.getColor(context, com.borjabravo.readmoretextview.R.color.accent));
